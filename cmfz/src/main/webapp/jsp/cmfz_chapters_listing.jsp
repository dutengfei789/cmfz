...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $("#myDataGrid").datagrid({
                url:"${pageContext.request.contextPath}/audio/getAudiosByPage",
                pagination:true,
                columns:[[
                    {field:"guruI1d",checkbox:true},
                    {field:'id',title:'音频编号',width:100},
                    {field:'name',title:'音频名称',width:100},
                    {field:'werw',title:'专辑名称',width:100,align:'right',formatter: function(value,row,index){
                            return row.album.name;
                        }
                    },
                    {field:'audioSize',title:'音频大小',width:100,align:'right'},
